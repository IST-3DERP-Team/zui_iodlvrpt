	...
	return {
        ...
        openLoadingDialog: function(doc) {
			if (!doc._LoadingDialog) {
				doc._LoadingDialog = sap.ui.xmlfragment("zuiasn.zuiasn.view.fragments.dialog.LoadingDialog", doc);
        ...
        openProcessingDialog(doc, msg) {
            if (!doc._ProcessingDialog) {
                doc._ProcessingDialog = sap.ui.xmlfragment("zuiiodlvrpt.view.fragments.dialog.ProcessingDialog", doc);

sap.ui.define([ 
	...
	return {
        ...
        setSmartFilterModel(oThis) {
            ...
            var me = oThis;
            var oModel = me.getOwnerComponent().getModel("ZVB_3D_IODLVRPT_FILTER_CDS");               
            ...
            var oModelURI = new sap.ui.model.odata.v2.ODataModel("/sap/opu/odata/sap/ZVB_3D_IODLVRPT_FILTER_CDS");
        ...
        onSmartFilterCustomControlValueHelp: function(oEvent) {
            ...
            this._oSmartFilterCustomControlValueHelpDialog = sap.ui.xmlfragment("zuiiodlvrpt.view.fragments.valuehelp.SmartFilterCustomControlValueHelpDialog", this);

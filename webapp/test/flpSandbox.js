					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IO Delivery Report",
									"targetURL": "#zuiiodlvrpt-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zuiiodlvrpt-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuiiodlvrpt",
									"url": sap.ui.require.toUrl("zuiiodlvrpt")
								}
							}
						}
					}
